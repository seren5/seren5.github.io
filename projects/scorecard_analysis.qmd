...
From the dataset, we investigated our question using the data of 50 colleges in Massachusetts with the largest undergraduate student population. Delving deeper, we explored the governance structure and retention rates.
Firstly, we grouped our selection of colleges based on the cities these are located in and then visualized the distribution of the type of governance structures – whether the colleges are Public, Private Non-profit, or Private For-profit.
Then, we examined the correlation between retention rates and the undergraduate population based on the type of institution to help us draw conclusions from the data.
